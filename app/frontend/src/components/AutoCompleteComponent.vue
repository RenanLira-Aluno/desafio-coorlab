...
<template>
    <div>
        ...
        <AutoComplete :input-id="id" v-model="selectInput" dropdown
            dropdown-class="absolute right-3 items-center text-center flex flex-row-reverse" rce-selection v-on:item-select="change"
