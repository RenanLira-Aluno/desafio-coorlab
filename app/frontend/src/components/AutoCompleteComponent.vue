...
<template>
    <div>
        ...
        <AutoComplete :input-id="id" v-model="selectInput" dropdown force-selection
            v-on:item-select="change" :suggestions="filteredOptions" @complete="search" :pt="{
            ...
            dropdownButton: 'absolute right-3',
